...
import { activateObject, byOrder, dispatch, type Claimable } from '../src/dispatch';

type Payload = { text: string };

function handler(log: string[], id: string, claims: boolean, order?: number): Claimable<Payload, number> {
	return {
