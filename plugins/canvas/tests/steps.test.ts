...
const read: StepDescriptor = { label: 'Explore', noun: 'file', verb: 'Read', detail: 'graph.ts', subject: 'src/graph.ts' };
const search: StepDescriptor = { label: 'Explore', noun: 'search', verb: 'Searched for', detail: 'todo', subject: 'todo' };
const run: StepDescriptor = { label: 'Terminal', noun: 'command', verb: 'Ran', detail: 'bun test', subject: 'bun test' };
