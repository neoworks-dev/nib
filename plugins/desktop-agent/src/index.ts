  ...
  apply(ctx) {
    ...
    ctx.effect(() =>
      panes.register({
        ...
        title: "Desktop",
        icon: MonitorIcon,
        component: DesktopPane,
      }),
    );
    ctx.effect(() =>
      ctx.require("slots").register("settings.section", { component: DesktopSettings, order: 40 }),
    );
    ...
    ctx.effect(() =>
      commands.register({
        id: "desktop.toggle",
        title: "Toggle desktop pane",
        run: () => panes.toggle("desktop"),
      }),
    );
    ctx.effect(() =>
      commands.register({
