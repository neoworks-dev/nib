import type { ApplicationIdentity, CanvasObject, DesktopRect, DetectedRegion, RegionSource } from '@nib-ui/ui-contracts';
...
export function parseDesktopRegions(raw: unknown): DesktopRegionsObject | null {
	...
	if (typeof candidate.captureObjectId !== 'string' || candidate.captureObjectId.length === 0) return null;
...
export function regionsFor(objects: readonly CanvasObject[], captureObjectId: string): DesktopRegionsObject | null {
