...
export function parseSettings(raw: string | null): UserSettings {
  ...
  return {
    theme:
      themePreferences.find((preference) => preference === stored.theme) ?? defaultSettings.theme,
    defaultHarnessId: typeof stored.defaultHarnessId === "string" ? stored.defaultHarnessId : null,
    defaultPermissionMode:
      typeof stored.defaultPermissionMode === "string" ? stored.defaultPermissionMode : null,
  };
}
