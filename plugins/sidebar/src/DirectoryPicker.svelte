...
<div class="relative">
  <div
    class="flex items-center gap-2 rounded-lg border border-line bg-input px-2 py-1.5 focus-within:border-line-strong"
  >
    ...
    >
      {#each suggestions as suggestion, index (suggestion.path)}
        <li>
          <button
            type="button"
            class="flex w-full items-center gap-2 px-3 py-1.5 text-left text-xs {index ===
            activeIndex
